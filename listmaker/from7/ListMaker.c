...
/*chmod 777 ListMaker*/
	...
	unsigned long NotBeginContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long BeginContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long NotEndContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long EndContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long NotContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long NotMaskLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long MaskLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long ContextLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long XORLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long ANDLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long NOTLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long ORLists(const char *DestName, const char *SrcName1, const char *SrcName2);
	unsigned long SquiseListC(const char *iName);
	unsigned long DuplicateList(const char *iName, const char *SourceName);
	unsigned long UniqueListC(const char *iName);
	void SortListC(const char *iName);
	unsigned long AddListC(const char *destList,const char *srcList);
	unsigned long AppendListC(const char *iName, const char * iList);
	unsigned long GetListItemCountC(const char *iName);
	unsigned long GetListStateC(const char *iName);
	unsigned long GetListLengthC(const char *iName);
	const char * GetListItemC(const char *iName, unsigned long iNItem);
	char GetListDelimiterC(const char *iName);
	char SetListDelimiterC(const char *iName,char newDelimiter);
	unsigned long GetCount();
	unsigned long SetListC(const char *iName, const char *iList,char delimiter);
	unsigned long LoadList(const char *iName);
	unsigned long CreateList(const char * iName);
	unsigned long DeleteListC(const char *iName);
	...
	unsigned long AppendList(unsigned long iIndex, const char * iList);
	const char * GetListItem(unsigned long iIndex, unsigned long iNItem);
	...
	unsigned long SetList(unsigned long iIndex, const char *iList,char delimiter);
	unsigned long GetListIndex(const char *LName);
	char ** cListArray;
	char *** ListPointers;
	char * cDelmiterArray;
...
int DoMethod(char *iStr, char **oStr)
{
	...
	int retint=-123456; 
	int atoipos;
	const unsigned long uNMethods=25;
