...
protected:
	...
	afx_msg long GPOLEGetInputString(BSTR FAR* oString, long GetFlag);
	afx_msg long GPOLEGetInputBytes(VARIANT FAR* ResArray, long GetFlag);
