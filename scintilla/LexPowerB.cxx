...
//             2. Own colors for PowerB constants and Inline Assembler SCE_B_CONSTANT and SCE_B_ASM
...
//
// Necessary changes for the PowerB lexer in Scintilla project:
//  - In SciLexer.h and Scintilla.iface:
//
//    #define SCLEX_POWERBASIC 51       //ID for PowerBasic lexer
//    (...)
//    #define SCE_B_DEFAULT 0           //in both VB and PowerB lexer
//    #define SCE_B_COMMENT 1           //in both VB and PowerB lexer
//    #define SCE_B_NUMBER 2            //in both VB and PowerB lexer
//    #define SCE_B_KEYWORD 3           //in both VB and PowerB lexer
//    #define SCE_B_STRING 4            //in both VB and PowerB lexer
//    #define SCE_B_PREPROCESSOR 5      //VB lexer only, not in PowerB lexer
//    #define SCE_B_OPERATOR 6          //in both VB and PowerB lexer
//    #define SCE_B_IDENTIFIER 7        //in both VB and PowerB lexer
//    #define SCE_B_DATE 8              //VB lexer only, not in PowerB lexer
//    #define SCE_B_CONSTANT 13         //PowerB lexer only, not in VB lexer
//    #define SCE_B_ASM 14              //PowerB lexer only, not in VB lexer

//  - Statement added to KeyWords.cxx:      'LINK_LEXER(lmPowerB);'
//  - Statement added to scintilla_vc6.mak: '$(DIR_O)\LexPowerB.obj: ...\src\LexPowerB.cxx $(LEX_HEADERS)'
//
...
static void ColourisePowerBDoc(unsigned int startPos, int length, int initStyle,WordList *keywordlists[],Accessor &styler) {
...
static void FoldPowerBDoc(unsigned int startPos, int length, int, WordList *[], Accessor &styler)
{
...
static const char * const powerbWordListDesc[] = {
    "Keywords",
    0
};

LexerModule lmPowerB(SCLEX_POWERBASIC, ColourisePowerBDoc, "powerbasic", FoldPowerBDoc, powerbWordListDesc);
