...
//gg
						cScPoint pts[] = {
    						cScPoint(centreX - halfWidth, centreY + halfWidth / 2),
    						cScPoint(centreX + halfWidth, centreY + halfWidth / 2),
    						cScPoint(centreX, centreY - halfWidth + halfWidth / 2),
						};
...
//gg
void CallTip::MouseClick(cScPoint pt) {
	clickPlace = 0;
...
//gg
PRectangle CallTip::CallTipStart(int pos, cScPoint pt, const char *defn,
