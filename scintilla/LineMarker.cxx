...
//gg
void LineMarker::Draw(Surface *surface, PRectangle &rcWhole, cScFont &fontForCharacter) {
...
//gg
		cScPoint pts[] = {
    		cScPoint(centreX - dimOn4, centreY - dimOn2),
    		cScPoint(centreX - dimOn4, centreY + dimOn2),
    		cScPoint(centreX + dimOn2 - dimOn4, centreY),
		};
...
//gg
		cScPoint pts[] = {
    		cScPoint(centreX - dimOn2, centreY - dimOn4),
    		cScPoint(centreX + dimOn2, centreY - dimOn4),
    		cScPoint(centreX, centreY + dimOn2 - dimOn4),
		};
		surface->Polygon(pts, sizeof(pts) / sizeof(pts[0]),
                 		fore.allocated, back.allocated);
...
//gg
		cScPoint pts[] = {
    		cScPoint(centreX - armSize, centreY - 1),
    		cScPoint(centreX - 1, centreY - 1),
    		cScPoint(centreX - 1, centreY - armSize),
    		cScPoint(centreX + 1, centreY - armSize),
    		cScPoint(centreX + 1, centreY - 1),
    		cScPoint(centreX + armSize, centreY -1),
    		cScPoint(centreX + armSize, centreY +1),
...
//gg
		cScPoint pts[] = {
			cScPoint(centreX, centreY + dimOn2),
			cScPoint(centreX + dimOn2, centreY),
			cScPoint(centreX, centreY - dimOn2),
			cScPoint(centreX, centreY - dimOn4),
			cScPoint(centreX - dimOn4, centreY - dimOn4),
			cScPoint(centreX - dimOn4, centreY + dimOn4),
			cScPoint(centreX, centreY + dimOn4),
			cScPoint(centreX, centreY + dimOn2),
		};
