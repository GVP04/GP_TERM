...
//gg
	...
	int MaxScrollPos();
//gg
	cScPoint LocationFromPosition(int pos);
	int XFromPosition(int pos);
//gg
	int PositionFromLocation(cScPoint pt);
//gg
	int PositionFromLocationClose(cScPoint pt);
	int PositionFromLineX(int line, int x);
//gg
	int LineFromLocation(cScPoint pt);
...
//gg
	bool NotifyMarginClick(cScPoint pt, bool shift, bool ctrl, bool alt);
	void NotifyNeedShown(int pos, int len);
//gg
	void NotifyDwelling(cScPoint pt, bool state);
	void NotifyZoom();
...
//gg
	bool PointInSelection(cScPoint pt);
	bool PointInSelMargin(cScPoint pt);
	void LineSelection(int lineCurrent_, int lineAnchor_);
	void DwellEnd(bool mouseMoved);
//gg
	virtual void ButtonDown(cScPoint pt, unsigned int curTime, bool shift, bool ctrl, bool alt);
	void ButtonMove(cScPoint pt);
	void ButtonUp(cScPoint pt, unsigned int curTime, bool ctrl);
...
//gg
	bool PointIsHotspot(cScPoint pt);
	void SetHotSpotRange(cScPoint *pt);
