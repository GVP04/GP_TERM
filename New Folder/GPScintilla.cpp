...
const UINT GPScintilla::uNKeybMethods=82;
const char *GPScintilla::cArrKeybMethods[82]={
...
const UINT  GPScintilla::uArrKeybMethods[82]={
...
const char *GPScintilla::cArrSearchFlags[6]={
		"MATCHCASE","POSIX","REGEXP","WHOLEWORD","WORDSTART","SELECTION",
		};
const UINT  GPScintilla::uArrSearchFlags[6]={
...
const UINT GPScintilla::uNLexer=81;
const char *GPScintilla::cArrLexer[81]={
...
const UINT  GPScintilla::uArrLexer[81]={
...
const UINT GPScintilla::uNStyles=888;
const char *GPScintilla::cArrStyles[888]={
			"SCLEX_CONTAINER",	"SCLEX_NULL",	"SCLEX_PYTHON",	"SCLEX_CPP",	"SCLEX_HTML",
			"SCLEX_XML",	"SCLEX_PERL",	"SCLEX_SQL",	"SCLEX_VB",	"SCLEX_PROPERTIES",
			"SCLEX_ERRORLIST",	"SCLEX_MAKEFILE",	"SCLEX_BATCH",	"SCLEX_XCODE",	"SCLEX_LATEX",
			"SCLEX_LUA",	"SCLEX_DIFF",	"SCLEX_CONF",	"SCLEX_PASCAL",	"SCLEX_AVE",
			...
			"SCRIPTOL_DEFAULT",	"SCRIPTOL_COMMENT",	"SCRIPTOL_WHITE",	"SCRIPTOL_COMMENTLINE",	"SCRIPTOL_COMMENTDOC",
			"SCRIPTOL_PERSISTENT",	"SCRIPTOL_CSTYLE",	"SCRIPTOL_WORD",	"SCRIPTOL_COMMENTBLOCK",	"SCRIPTOL_NUMBER",
			"SCRIPTOL_STRING",	"SCRIPTOL_UUID",	"SCRIPTOL_CHARACTER",	"SCRIPTOL_STRINGEOL",	"SCRIPTOL_KEYWORD",
			"SCRIPTOL_OPERATOR",	"SCRIPTOL_IDENTIFIER",	"SCRIPTOL_VERBATIM",	"SCRIPTOL_TRIPLE",	"SCRIPTOL_REGEX",
			"SCRIPTOL_CLASSNAME",	"SCRIPTOL_COMMENTLINEDOC",	"SCRIPTOL_PREPROCESSOR",	"SCRIPTOL_WORD2",	"SCRIPTOL_COMMENTDOCKEYWORD",
			"SCRIPTOL_COMMENTDOCKEYWORDERROR",	"SCRIPTOL_COMMENTBASIC",	"ASM_DEFAULT",	"ASM_COMMENT",	"ASM_NUMBER",
			...
			"POV_COMMENT",	"POV_COMMENTLINE",	"POV_COMMENTDOC",	"POV_NUMBER",	"POV_OPERATOR",
			"POV_WORD",	"POV_IDENTIFIER",	"POV_STRING",	"POV_STRINGEOL",	"POV_DIRECTIVE",
			"POV_BRACE",	"POV_BADDIRECTIVE",	"POV_WORD2",	"POV_WORD3",	"POV_WORD4",
...
const UINT  GPScintilla::uArrStyles[888]={
			SCLEX_CONTAINER,	SCLEX_NULL,	SCLEX_PYTHON,	SCLEX_CPP,	SCLEX_HTML,
			SCLEX_XML,		SCLEX_PERL,	SCLEX_SQL,	SCLEX_VB,	SCLEX_PROPERTIES,
			SCLEX_ERRORLIST,	SCLEX_MAKEFILE,	SCLEX_BATCH,	SCLEX_XCODE,	SCLEX_LATEX,
			SCLEX_LUA,		SCLEX_DIFF,	SCLEX_CONF,	SCLEX_PASCAL,	SCLEX_AVE,
			...
			SCE_SCRIPTOL_DEFAULT,	SCE_SCRIPTOL_COMMENT,	SCE_SCRIPTOL_WHITE,	SCE_SCRIPTOL_COMMENTLINE,	SCE_SCRIPTOL_COMMENTDOC,
			SCE_SCRIPTOL_PERSISTENT,	SCE_SCRIPTOL_CSTYLE,	SCE_SCRIPTOL_WORD,	SCE_SCRIPTOL_COMMENTBLOCK,	SCE_SCRIPTOL_NUMBER,
			SCE_SCRIPTOL_STRING,	SCE_SCRIPTOL_UUID,	SCE_SCRIPTOL_CHARACTER,	SCE_SCRIPTOL_STRINGEOL,	SCE_SCRIPTOL_KEYWORD,
			SCE_SCRIPTOL_OPERATOR,	SCE_SCRIPTOL_IDENTIFIER,	SCE_SCRIPTOL_VERBATIM,	SCE_SCRIPTOL_TRIPLE,	SCE_SCRIPTOL_REGEX,
			SCE_SCRIPTOL_CLASSNAME,	SCE_SCRIPTOL_COMMENTLINEDOC,	SCE_SCRIPTOL_PREPROCESSOR,	SCE_SCRIPTOL_WORD2,	SCE_SCRIPTOL_COMMENTDOCKEYWORD,
			SCE_SCRIPTOL_COMMENTDOCKEYWORDERROR,	SCE_SCRIPTOL_COMMENTBASIC,	SCE_ASM_DEFAULT,	SCE_ASM_COMMENT,	SCE_ASM_NUMBER,
			...
			SCE_POV_COMMENT,	SCE_POV_COMMENTLINE,	SCE_POV_COMMENTDOC,	SCE_POV_NUMBER,	SCE_POV_OPERATOR,
			SCE_POV_WORD,	SCE_POV_IDENTIFIER,	SCE_POV_STRING,	SCE_POV_STRINGEOL,	SCE_POV_DIRECTIVE,
			SCE_POV_BRACE,	SCE_POV_BADDIRECTIVE,	SCE_POV_WORD2,	SCE_POV_WORD3,	SCE_POV_WORD4,
			...
			if (nfunc<64)
			{
				...
				case 6: /*KeybAction*/
					{
						...
						if (kb!="")
						{
							...
							UINT i=0;
							kb.MakeUpper();
							for(i=0;i<GPScintilla::uNKeybMethods && met333==0;i++)
				...
				case 7: /*AssignCmdKey*/
					...
					if (*pos)
					{
						...
						{
							UINT i;
							for(i=0;i<GPScintilla::uNKeybMethods && dcmd==0;i++)
		...
		if (nfunc<380)
		{
			...
			case 278: /*SetLexer*/
				{
					...
					if (Lexer==0)
					{
						...
						_strupr(pos333);
						UINT i;
						for(i=0;i<GPScintilla::uNLexer;i++)
			...
			case 279: /*GetLexer*/
				if (oStr)
				{
					...
					UINT i;
					for(i=0;i<GPScintilla::uNLexer && *oStr==0;i++)
...
BOOL GPScintilla::LoadKeywords(UINT uLexerType)
{
	...
	if (uLexNum<GPScintilla::uNLexer)
	{
		FILE *src=NULL;
...
UINT GPScintilla::GetLexerId(const char *iLexerName)
{
	UINT ret=-1;
	int i=0;
	for(i=0;i<(int)GPScintilla::uNLexer && _stricmp(GPScintilla::cArrLexer[i],iLexerName);i++);

	if (i<(int)GPScintilla::uNLexer) ret=GPScintilla::uArrLexer[i];
...
const char * GPScintilla::GetLexerName(DWORD iLexerID)
{
	const char * ret="";
	int i=0;
	for(i=0;i<(int)GPScintilla::uNLexer && GPScintilla::uArrLexer[i]!=iLexerID;i++);

	if (i<(int)GPScintilla::uNLexer) ret=GPScintilla::cArrLexer[i];
