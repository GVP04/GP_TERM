...
const char *m_TermVersion="G2.5.1.6";
int m_LastScanf;
GPCurrent GPC;
...
const char *aUnitCommonMessages="OnSetFocus,OnKillFocus,OnCSetFocus,OnCKillFocus,OnTimer,OnClose,OnEnter,OnLockEnter,OnCtrlEnter,OnLockCtrlEnter,OnTab,OnBackTab,OnLockTab,OnLockBackTab,OnDrop,OnDragHover,OnDragMove,OnDragLeave,OnValChange,OnValChangeEx,";
