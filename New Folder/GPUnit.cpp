...
const UINT GPUnit::uNMethods=147;
...
/*145*/ "SetLayeredWindowAttributes","ShowWindowAsync","","","",
/*150*/ "","","","","",
/*155*/ "","","","","",
	};
...
/*20*/	"","","","x,y,cx,cy,nObjAfter,Style","xTL,yTL,xBR,yBR,bRepaint",
...
BOOL GPUnit::MouseWheelProc(WPARAM wParam, LPARAM lParam)
{
	...
	{
		int i=0;
		DWORD dwStl=::GetWindowLong(scrlWnd,GWL_STYLE);
		while(i++<5 && !(dwStl&(WS_VSCROLL|WS_HSCROLL)))
		{
			scrlWnd=::GetParent(scrlWnd);
			dwStl=::GetWindowLong(scrlWnd,GWL_STYLE);
		}
